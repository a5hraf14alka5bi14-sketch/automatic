  ...
  return (
    <>
      ...
      <aside
        ...
        `}
      >
        {/* sidebar-header-safe: keeps the normal 1 rem padding and adds
            env(safe-area-inset-top) so the logo / close button clears the
            notch or Dynamic Island when the drawer opens on iOS. */}
        <div className="px-4 pb-4 border-b border-slate-800 flex items-center gap-3 sidebar-header-safe">
        ...
        <div className="px-3 pt-3 border-t border-slate-800 sidebar-footer-safe">
          {expanded ? (
            <div className="space-y-1">
              ...
              <InstallButton expanded onNavigate={() => setMobileOpen(false)} />
            </div>
          ) : (
