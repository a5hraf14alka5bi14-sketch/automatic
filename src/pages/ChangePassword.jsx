...
export default function ChangePassword({ forced = false, onChanged }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // On native shells, store the rotated tokens. Crucial for the forced-change
      // flow: the old access token still carries mustChange=true, so without this
      // the app would stay blocked by enforcePasswordChange after a valid change.
