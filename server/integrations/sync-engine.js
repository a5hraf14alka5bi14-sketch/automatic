...
export async function runSync(service = 'notion') {
  // nosemgrep: config..semgrep.vendored-rules.javascript.lang.security.audit.unsafe-dynamic-method -- `service` is an internal registry key (only ever 'notion' from startAutoSync/runSync defaults), never user-controlled
